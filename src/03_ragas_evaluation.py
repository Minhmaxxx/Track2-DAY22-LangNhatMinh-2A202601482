...
DELIVERABLE: faithfulness ≥ 0.8 cho ít nhất 1 prompt version
             + file data/ragas_report.json và evidence/03_ragas_report.json
"""
import sys
...
def run_ragas_eval(rag_results: list, version: str) -> dict:
    ...
    Lưu ý: evaluate() thực hiện nhiều lần gọi LLM để đánh giá.
    """
...
def main():
    ...
    print(f"💾 Đã lưu bản sao báo cáo vào {evidence_report_path}")
