...
PROMPT_V1_NAME = "rag-prompt-concise-v1"                                                                                                                                        
PROMPT_V2_NAME = "rag-prompt-structured-v2"                                                                                                                                     
                                                                                                                                                                                    
SYSTEM_V1 = """Bạn là trợ lý AI hữu ích. Hãy trả lời câu hỏi dựa CHỈ trên context được cung cấp dưới đây.                                                                       
    Giữ câu trả lời thật ngắn gọn, súc tích (khoảng 2-4 câu), đi thẳng vào trọng tâm.                                                                                               
...
SYSTEM_V2 = """Bạn là chuyên gia phân tích thông tin AI. Hãy đọc kỹ context dưới đây và đưa ra câu trả lời toàn diện, có tổ chức và cấu trúc rõ ràng (khoảng 3-5 câu).          
    Chỉ sử dụng các sự thật (facts) được nêu trong context.                                                                                                                         
...
def push_prompts_to_hub(client: Client):                                                                                                                                        
        try:                                                                                                                                                                        
            url1 = client.push_prompt(PROMPT_V1_NAME, object=PROMPT_V1, description="V1 – Ngắn gọn súc tích")                                                                       
            print(f"✅ Đã push V1 → {url1}")                                                                                                                                        
        except Exception as e:                                                                                                                                                      
            print(f"⚠️  V1 lỗi: {e}")                                                                                                                                               
                                                                                                                                                                                    
        try:                                                                                                                                                                        
            url2 = client.push_prompt(PROMPT_V2_NAME, object=PROMPT_V2, description="V2 – Chuyên gia có cấu trúc")                                                                  
